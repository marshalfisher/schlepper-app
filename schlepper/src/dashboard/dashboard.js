    ...
    return (
        <div className="dashboard">
          ...
          <div className="Collection">
            ...
            {collection.map(a => <MiniAlbum key={a} albumID={a} username={username} handleClick={deleteCollection} clickValue="Remove"/>)}
          </div>
          <div className="Wants">
          <h3>Your Wants</h3>
          {wants.map(a => <MiniAlbum key={a} albumID={a} username={username} handleClick={deleteWant} clickValue="Remove"/>)}
          </div>
        </div>
    )
}
